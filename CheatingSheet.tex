...
\begin{cheatsheet}
  \input{contents/1流动分析基础.tex}
  \input{contents/2流体静力学基础.tex}
  \input{contents/3流体动力学基础.tex}
  \input{contents/4黏性流体运动及其阻力计算.tex}
  \input{contents/5流动分析基础.tex}
  \input{contents/6导热的理论基础与计算.tex}
  \input{contents/7对流传热的理论基础与计算.tex}
  \input{contents/8辐射传热的理论基础与计算.tex}
  \input{contents/9传热过程分析与换热器基础.tex}
\end{cheatsheet}
\end{document}
